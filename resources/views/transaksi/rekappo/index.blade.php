                ...
                <div class="col-md-12 col-lg-6 col-xl-4">
                    ...
                    <div class="m-widget24">
                        <div class="m-widget24__item">
                            ...
                            <span class="m-widget24__stats m--font-success">
                                {{ $rekappos->where('is_published', 1)->count() }}
                                {{-- <a href="/vendors"></a>  --}}
                ...
                <div class="col-md-12 col-lg-6 col-xl-4">
                    ...
                    <div class="m-widget24">
                        <div class="m-widget24__item">
                            ...
                            <span class="m-widget24__stats m--font-success">
                                {{ $rekappos->where('is_published', 0)->count() }}
                        ...
                        <div class="modal fade" id="poMdl" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="/rekappo/exportPDF" method="get">
                                        @csrf
...
<div class="modal fade" id="m_modal_4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/rekappo/exportXLS" method="GET" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
        ...
        <div class="modal-footer">
          ...
          <a href="/rekappo/exportXLS" target="_blank" class="btn btn-primary">Export</a>
