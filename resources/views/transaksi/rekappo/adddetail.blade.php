            ...
            <div class="m-portlet">
                <div class="m-portlet__body m-portlet__body--no-padding">
                    <div class="m-invoice-2">
                        <form action="/rekappo/detail/store" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                @foreach ($rekappos->podetails as $detail)
                                    <input type="hidden" name="poheader_id[]" value="{{ $detail->id }}" />
                                    <input type="hidden" name="hargabarang_id[]" value="{{ $detail->hargabarang_id }}" />
                                    ...
                                    {{-- <input type="hidden" name="currency_id[]" value="{{ $detail->currency_id }}" /> --}}
                                    ...
                                    <div class="m-invoice__container m-invoice__container--centered">
                                        ...
                                        <div class="m-invoice__items">
                                            ...
                                            <div class="m-invoice__item">
                                                ...
                                                <span class="m-invoice__text">{{ $rekappos->nilai_rap }}</span>
                                            </div>
                                            <div class="m-invoice__item">
                                        ...
                                        <div class="m-invoice__items">                                            
                                            ...
                                            <div class="m-invoice__item">
                                                {{-- <span class="m-invoice__subtitle">Lokasi</span>
                                                <span class="m-invoice__text">{{ $rekappos->lokasi->kode }}</span> --}}
                                                <span class="m-invoice__subtitle">Asuransi</span>
                                                <span class="m-invoice__text">
                                                    @if ($rekappos->asuransi == "exclude")
                                ...
                                <div class="m-invoice__body m-invoice__body--centered">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            @php
                                                // $diskon = $subtotal - $request->diskon ;
                                                if ($rekappos->pajak == "ppn") {                                                    
						                            $subatotal = $subtotal - $rekappos->diskon;
						                            $ppn = $subatotal * 10/100; 
                                                    $total = $subatotal + $ppn + $rekappos->biaya_kirim  + $rekappos->custom1;    
                                                    $total_rp = $total;
                                                } 
                                                elseif ($rekappos->pajak == "ppn11") {                                                    
						                            $subatotal = $subtotal - $rekappos->diskon;
                                            ...
                                            <tfoot>
                                                ...
                                                @if ($ppn)
                                                    <tr>
                                                        ...
                                                        {{-- <td>
                                                            <input type="text" name="ppn"  style="text-align: right" width="150px" class="form-control" value="{{ format_uang($ppn)  }}" readonly>
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- <td > --}}
                                                        <td class="m--font-success" style="text-align: right"> <strong id="afdpp">{{$rekappos->currency->name . " " . format_uang($total) }}</strong> </td>
                                                        {{-- {!! Form::label($for, $text, [$options]) !!} --}}
                                                        {{-- <input type="hidden" style="text-align: right" name="total" class="form-control" value="{{ format_uang($total) }}" readonly> --}}
                                        ...
                                        <div class="m-invoice__item">
                                            <span class="m-invoice__subtitle">Catatan :</span><br>                                          
                                                <ol type="I">
                                                    ...
                                                    <li>  <span class="m-invoice__text">v Sesuai Surat Penawaran Harga {{ $rekappos->desc }} Tanggal {{ $rekappos->desc_tgl }} </span> </li>
                                                    @else
                                                       <li> <span class="m-invoice__text">v Sesuai Surat Penawaran Harga Nego No {{ $rekappos->desc }} Tanggal {{ $rekappos->desc_tgl }} </span></li>
                                                    @endif
                                                       <li> <span class="m-invoice__text">v Mohon dapat diemail kembali setelah PO diterima, ditandatangan dan stempel perusahaan.  </span>  </li>
                                                </ol>
                                        </div>
                                    </div>
                                    <hr>
