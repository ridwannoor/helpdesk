                    ...
                    <div class="m-invoice-2">
                        <div class="m-invoice__wrapper">
                                ...
                                <div class="m-invoice__container m-invoice__container--centered">
                                    ...
                                    <div class="m-invoice__items">
                                        <div class="m-invoice__item">
                                            ...
                                            <span class="m-invoice__text">{{ $bapm->vendor->namaperusahaan }},  {{ $bapm->vendor->badanusaha->kode }}</span>
                                            <span class="m-invoice__text">{{ $bapm->vendor->alamat }}</span>
                                            <span class="m-invoice__text">{{ $bapm->vendor->email }}</span>
                                            <span class="m-invoice__text">{{ $bapm->vendor->notelp }}</span>
                                        </div>
                                        <div class="m-invoice__item">
                            ...
                            <div class="m-invoice__footer">
                                {{-- <div class="m-invoice__items">
                                    <div class="m-invoice__item">
                                        <span class="m-invoice__subtitle">Diterima Oleh :</span>
