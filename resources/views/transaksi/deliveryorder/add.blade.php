    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="m-portlet">
                ...
                <!--begin::Form-->
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="POST" action="/do/store" enctype="multipart/form-data">
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="no_do" class="form-control m-input" value="{{ $noUrutAkhir }}" readonly>
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="ref_po" class="form-control m-input" >
                                {{-- <span class="m-form__help">Please enter your full name</span> --}}
                            </div>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group date">
                                        <input type="text" class="form-control m-input" name="tgl_mulai" readonly  placeholder="Select Date" id="tglmulai"/>
                                        <span class="input-group-text">-</span><input type="text" class="form-control m-input" name="tgl_akhir" readonly  placeholder="Select Date" id="tglakhir"/>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="input-group date">
                                        <input type="text" class="form-control m-input" name="tgl_pengiriman" readonly  placeholder="Select Date" id="tglkirim"/>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="la la-calendar-check-o"></i>
                                            </span>
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6">
                                ...
                                <textarea name="lokasi_pengambilan" class="form-control m-input m-input--air" id="exampleTextarea" rows="3"></textarea>
                            ...
                            <div class="col-lg-6">
                                ...
                                <textarea name="tujuan_pengiriman" class="form-control m-input m-input--air" id="exampleTextarea" rows="3"></textarea>
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6">
                                ...
                                <textarea name="perihal" class="form-control m-input m-input--air" id="exampleTextarea" rows="3"></textarea>
                                {{-- <input type="email" class="form-control m-input" placeholder="Enter contact number"> --}}
                                {{-- <span class="m-form__help">Please enter your contact</span> --}}
                            </div>
                            <div class="col-lg-3">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    ...
                                                    </div>{{-- <input type="text" name="deskripsi[]" class="form-control m-input" required> --}}
                                                </td>
                                                <td><input type="text" name="qty[]" id="qty" class="form-control m-input" required></td>
                                                <td><input type="text" name="satuan[]" class="form-control m-input" id="satuan" readonly></td>
                                                <td>
                                                    <select name="catatan[]" id="catatan" class="form-control m-input">
