                            ...
                            <div class="m-invoice__head"
                                ...
                                <div class="m-invoice__container m-invoice__container--centered">
                                    <div class="m-invoice__logo">
                                        <a href="#">
                                            <h3>DELIVERY ORDER (DO)</h3>
                                        </a>
                                        <a href="#">
                                          {{-- <img src="{{ url('data_file/'.$preferences->image) }}" width="150px" alt="">   --}}
                                        </a>
                                    </div>
                                    ...
                                    <div class="m-invoice__items">
                                        ...
                                        {{-- <div class="m-invoice__item">
                                            ...
                                            <span class="m-invoice__text">{{ $preferences->nama_perusahaan }}</span>
                                            <span class="m-invoice__text">{{ $preferences->address }}</span>
                                            <span class="m-invoice__text">{{ $preferences->email }}</span>
                                            <span class="m-invoice__text">{{ $preferences->phone }}</span> --}}
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="vertical-align : middle;text-align:center;">Material/Barang</th>
                                ...
                                <div class="m-invoice__table  m-invoice__table--centered table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>Diterima Oleh :</th>
                                                {{-- <th>{{$preferences->nama_perusahaan}}</th>                                                --}}
                                            </tr>
                                        </thead>
                                        <tbody>
