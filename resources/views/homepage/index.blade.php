...
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        ...
        <div>
            ...
            <!-- Modal -->
            <div class="modal fade" id="searchMdl" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                    ...
                    <div class="row m-row--no-padding m-row--col-separator-xl">
                        <div class="col-xl-12">
                            <div class="m-widget14">
                                ...
                                <div class="row" >
 				                    <div class="col p-4 m-2" style="background-color: rgb(101, 0, 178); border-radius:10px">
                                        <strong class="text-white">Bidang Pekerjaan</strong> <hr>
                                    ...
                                    <div class="col p-4 m-2" style="background-color: rgb(101, 0, 178); border-radius:10px">
                                        ...
                                        <strong class="text-white">Kategori Pekerjaan</strong> <hr>
                                    ...
                                    <div class="col p-4 m-2" style="background-color: rgb(101, 0, 178); border-radius:10px">
                                        <strong class="text-white">Jenis Usaha</strong> <hr>
        ...
        <div class="m-portlet">
            <div class="m-portlet__body">
                ...
                <div class="col-lg-4" style="background-color: rgb(37, 51, 133);border-radius:10px;">
                    <div class="card text-info overflow-hidden mb-3 mt-4" style="line-height: 2.5 ; border: #ebebeb;  background-color: rgb(37, 51, 133)">
                        <div class="p-3 pb-2">
                            <strong class="mb-3"><i class="demo-psi-data-storage text-white text-opacity-75 fs-3 me-2"></i><span class="text-white"> BA Aawizing (Procurement)</span> 
                    ...
                    <div class="card text-info overflow-hidden mb-3" style="line-height: 2.5 ; border: #ebebeb;  background-color: rgb(37, 51, 133)">
                        <div class="p-3 pb-2">
                            <strong class="mb-3"><i class="demo-psi-data-storage text-reset text-opacity-75 fs-3 me-2"></i><span class="text-white"> BA Klarif & Nego (Procurement) </span>
                            ...
                            <ul class="list-group list-group-borderless">
                                ...
                                <li class="list-group-item p-3 text-reset d-flex justify-content-between align-items-start">
                                    ...
                                    <span class="fw-bold  text-white">{{'Rp ' . number_format($basph2)  }}</span>
                                </li>
                    ...
                    <div class="card text-info overflow-hidden mb-3" style="line-height: 2.5 ; border: #ebebeb;  background-color: rgb(37, 51, 133)"> 
                        <div class="p-3 pb-2">
                            <strong class="mb-3"><i class="demo-psi-data-storage text-reset text-opacity-75 fs-3 me-2"></i><span class="text-white"> SPK (Procurement) </span>
                    ...
                    <div class="card text-info overflow-hidden mb-3" style="line-height: 2.5 ; border: #ebebeb;  background-color: rgb(37, 51, 133)"> 
                        <div class="p-3 pb-2">
                            <strong class="mb-3"><i class="demo-psi-data-storage text-reset text-opacity-75 fs-3 me-2"></i> <span class="text-white">SPP (Procurement)  </span>
                    ...
                    <div class="row">
                       ...
                       {{-- <div class="row"> --}}
                        ...
                        <div class="col p-4 m-2 " style="background-color: rgb(37, 51, 133); border-radius:10px">
                            <div class="card text-info overflow-hidden mb-3 mt-3" style="line-height: 2.5 ; border: #ebebeb;background-color: rgb(37, 51, 133)">
                                <div class="p-3 pb-2">
                                    <strong class="mb-3"><i class="demo-psi-data-storage text-reset text-opacity-75 fs-3 me-2"></i><span class="text-white"> Purchase Order (Logistic) </span>
                                    ...
                                    <ul class="list-group list-group-borderless">
                                        ...
                                        <li class="list-group-item p-3 text-primary d-flex justify-content-between align-items-start">
                                            ...
                                            <span class="fw-bold text-white">{{ "Rp ". number_format($pototals) }}</span>
                                        </li>
                            ...
                            <div class="card text-info overflow-hidden mb-3 mt-3"  style="line-height: 2.5 ; border: #ebebeb; background-color: rgb(37, 51, 133)">
                                <div class="p-3 pb-2">
                                    <strong class="mb-3"><i class="demo-psi-data-storage text-reset text-opacity-75 fs-3 me-2"></i><span class="text-white">BA Klarif & Nego (Logistic)</span>
                        ...
                        <div class="col p-4 m-2 " style="background-color: rgb(37, 51, 133); border-radius:10px">
                            <div class="card text-success overflow-hidden mb-3 mt-3"  style="line-height: 2.5 ; border: #ebebeb; background-color: rgb(37, 51, 133)">
                                <div class="p-3 pb-2">
                                    <strong class="mb-3"><i class="demo-psi-data-storage text-reset text-opacity-75 fs-3 me-2"></i><span class="text-white"> PUM (Logistic) </span>
                            ...
                            <div class="card text-primary overflow-hidden mb-3 mt-3"  style="line-height: 2.5 ; border: #ebebeb; background-color: rgb(37, 51, 133)">
                                <div class="p-3 pb-2">
                                    <strong class="mb-3"><i class="demo-psi-data-storage text-reset text-opacity-75 fs-3 me-2"></i><span class="text-white">Pengiriman-DO/GR (Logistic) </span>
                            ...
                            <div class="card text-info overflow-hidden mb-3"  style="line-height: 2.5 ; border: #ebebeb; background-color: rgb(37, 51, 133)">
                                <div class="p-3 pb-2">
                                    <strong class="mb-3"><i class="demo-psi-data-storage text-reset text-opacity-75 fs-3 me-2"></i><span class="text-white">Service Order (Logistic)</span>
...
<div class="col-lg-12">
    ...
    <div class="m-portlet m-portlet--mobile">
        ...
        $no =1 ;
        @endphp
        <div class="m-portlet__body  m-scrollable" data-scrollable="true" style="height: 500px">
                    ...
                    <tr>
                        ...
                        <td style="width: 150px">
                                {{-- <div class="m-stack__item m-stack__item--center m-stack__item--bottom m--bg-brand text-center p-4"> --}}
                                    <h6 class="m--font-dark">{{ date('d M Y', strtotime($log->created_at))  }}</h6>
                                {{-- </div> --}}
                        </td>
                        <td style="width: 50px">
