            ...
            <div class="m-section__content">
                ...
                <div class="m-demo" data-code-preview="true" data-code-html="true" data-code-js="false">
                    ...
                    <div class="m-demo__preview m-demo__preview--badge">
                       ...
                       @endphp --}}
                            <span class="m-badge m-badge--default m-badge--wide p-3"><a href="/vendor/tender/jasakontruksi"><strong>Jasa Konstruksi</strong></a></span>
                            <span class="m-badge m-badge--default m-badge--wide p-3"><a href="/vendor/tender/jasakonsultankonstruksi"><strong>Jasa Konsultan Konstruksi</strong></a></span>
                            <span class="m-badge m-badge--default m-badge--wide p-3"><a href="/vendor/tender/pengadaanbarang"><strong>Pengadaan Barang/ Material Konstruksi</strong></a></span>
                            <span class="m-badge m-badge--default m-badge--wide p-3"><a href="/vendor/tender/jasakonsultan"><strong>Jasa Konsultan Lainnya</strong></a></span>
                            <span class="m-badge m-badge--default m-badge--wide p-3"><a href="/vendor/tender/jasalain"><strong>Jasa Lainnya</strong></a></span>
                       {{-- @endforeach --}}
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach ($tenders as $tds)
                                <tr>
                                    ...
                                    <td><a href="/vendor/tender/show/{{ $tds->id }}">{{ $tds->nomor_pr }}</a> <br> {{ $tds->nama_paket }}</td>
