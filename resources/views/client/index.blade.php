...
<!-- Mirrored from keenthemes.com/metronic/preview/?page=snippets/pages/user/login-1&demo=default by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Mar 2019 09:17:41 GMT -->
				...
				<div class="m-stack__item m-stack__item--fluid">
					...
					<div class="m-login__wrapper">
						...
						<div class="m-login__logo">
							<a href="#">
							<img src="{{ url('data_file/'.$pref->image) }}" width="100%">  	
							</a>
						</div>
						...
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" method="POST" action="{{ route('client.submit') }}" enctype="multipart/form-data">
                                @csrf
...
<!-- Mirrored from keenthemes.com/metronic/preview/?page=snippets/pages/user/login-1&demo=default by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Mar 2019 09:19:01 GMT -->
</html>