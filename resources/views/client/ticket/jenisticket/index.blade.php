            ...
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-tools">
                    <ul class="m-portlet__nav">
                        ...
                        {{-- <li class="m-portlet__nav-item">
                            <a href="/ticket/exportPDF" target="_blank" class="btn btn-danger m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air" rel="noopener noreferrer"> <i class="fa fa-file-pdf"></i>&nbsp; Export PDF </a>
                        </li> --}}
                    </ul>
                </div>
            </div>
                                            ...
                                            <div class="m-dropdown__inner">
                                                <div class="m-dropdown__body">              
                                                    <div class="m-dropdown__content">
                                                        <ul class="m-nav">                                              
                                                                {{-- <li class="m-nav__item">
                                                                    <a href="/ticket/rekap/{{$brg->id}}" class="m-nav__link"><i class="m-nav__link-icon fa fa-file-pdf"></i>  <span class="m-nav__link-text">Rekap</span></a>
                                                                </li>                             --}}
                                                            {{-- @if ($crud->cetak)                        --}}
                                                            {{-- <li class="m-nav__item">
                                                                <a href="/ticket/cetak/{{$brg->id}}" class="m-nav__link"><i class="m-nav__link-icon flaticon-technology"></i>  <span class="m-nav__link-text">Print</span></a>
                                                            </li>   --}}
                                                            {{-- @endif               --}}
                                                            {{-- <li class="m-nav__item">
                                                                <a href="/ticket/upload/{{$brg->id}}" class="m-nav__link"><i class="m-nav__link-icon flaticon-upload"></i>  <span class="m-nav__link-text">Upload File</span></a>
                                                            </li>                                    --}}
                                                            {{-- @if ($crud->edit) --}}
                                                            <li class="m-nav__item">
                                                                <a href="/ticket/edit/{{$item->id}}" class="m-nav__link"><i class="m-nav__link-icon flaticon-edit"></i>  <span class="m-nav__link-text">Edit</span></a>
                                                            </li>  
                                                            {{-- @endif               --}}
                                                            {{-- @if ($crud->destroy) --}}
                                                            <li class="m-nav__item">
                                                                <a href="/ticket/destroy/{{$item->id}}" class="m-nav__link delete-confirm"><i class="m-nav__link-icon flaticon-delete"></i>  <span class="m-nav__link-text">Hapus</span></a>
                                                            </li>
                                                            {{-- @endif                                        --}}
                                                        </ul>
                                                    </div>
