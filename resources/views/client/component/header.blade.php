                        ...
                        <div class="m-stack m-stack--ver m-stack--general">
                            <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                <a href="index9bfb.html?page=index&amp;demo=default" class="m-brand__logo-wrapper">
                                    <img alt="" src="{{ url('data_file/'.$pref->image) }}" style="background-color: white ; padding: 10px" width="100%" />
                                </a>
                            </div>
                    ...
                    <div class="m-stack__item m-stack__item--fluid m-header-head" id="m_header_nav">
                                                    ...
                                                    <ul class="m-menu__inner">
                                                        ...
                                                        <li class="m-menu__item " m-menu-link-redirect="1"
                                                            aria-haspopup="true"><a
                                                                ...
                                                                class="m-menu__link "><i
                                                                    class="m-menu__link-bullet m-menu__link-bullet--line"><span></span></i><span
                                                                    class="m-menu__link-text">Delta Airlines Booking
                                                                    Site</span></a></li>
                                                        <li class="m-menu__item " m-menu-link-redirect="1"
                                                            aria-haspopup="true"><a
                                                                href="index07a2.html?page=header/actions&amp;demo=default"
                                                        ...
                                                        <li class="m-menu__item " m-menu-link-redirect="1"
                                                            aria-haspopup="true"><a
                                                                ...
                                                                class="m-menu__link "><i
                                                                    class="m-menu__link-bullet m-menu__link-bullet--line"><span></span></i><span
                                                                    class="m-menu__link-text">Vineseed Website
                                                                    Rewamp</span></a></li>
                                                        <li class="m-menu__item " m-menu-link-redirect="1"
                                                            aria-haspopup="true"><a
                                                                href="index07a2.html?page=header/actions&amp;demo=default"
                                ...
                                <ul class="m-topbar__nav m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
                                        ...
                                        <a href="#" class="m-nav__link m-dropdown__toggle">
                                            ...
                                            <span class="m-topbar__username m--hide">{{ Auth::user('client')->name }}</span>
                                        </a>
                                        <div class="m-dropdown__wrapper">
                                            <span
                                                class="m-dropdown__arrow m-dropdown__arrow--right m-dropdown__arrow--adjust"></span>
						...
						-->
                                                        ...
                                                        <div class="m-card-user__details">
                                                            <span class="m-card-user__name m--font-weight-500">{{ Auth::user('client')->name }}</span>
                                                            <a href="#"
                                                                class="m-card-user__email m--font-weight-300 m-link">{{ Auth::user('client')->email }}</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="m-dropdown__body">
