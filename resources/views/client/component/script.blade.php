    ...
    <script src="{{ asset('client/metro/assets/vendors/base/vendors.bundle.js') }}" type="text/javascript"></script>
    <script src="{{ asset('client/metro/assets/demo/default/base/scripts.bundle.js') }}" type="text/javascript"></script>
