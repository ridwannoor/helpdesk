<div class="modal fade" id="fileupload_modal_10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/vendor/upload/simpan" method="POST" enctype="multipart/form-data">
