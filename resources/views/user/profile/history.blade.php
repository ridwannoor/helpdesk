                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="col-lg-3">
                            <div class="card text-left">
                              ...
                              <div class="card-body text-center">
                                <h4 class="card-title ">{{ $historys->banego->count() }}</h4>
                        ...
                        <div class="col-lg-3">
                            <div class="card text-left">
                              <img class="card-img-top" src="holder.js/100px180/" alt="">
                              <div class="card-body text-center">
                                <h4 class="card-title ">{{ $historys->rekappos->count() }}</h4>
                        ...
                        <div class="col-lg-3">
                            <div class="card text-left">
                              <img class="card-img-top" src="holder.js/100px180/" alt="">
                              <div class="card-body text-center">
                                <h4 class="card-title ">{{ $historys->doheaders->count() }}</h4>
                        ...
                        <div class="col-lg-3">
                            <div class="card text-left">
                              <img class="card-img-top" src="holder.js/100px180/" alt="">
                              <div class="card-body text-center">
                                <h4 class="card-title ">{{ $historys->pumheaders->count() }}</h4>
                        ...
                        <div class="col-lg-3 mt-4">
                            <div class="card text-left">
                              <img class="card-img-top" src="holder.js/100px180/" alt="">
                              <div class="card-body text-center">
                                <h4 class="card-title ">{{ $historys->pjpumheaders->count() }}</h4>
                        ...
                        <div class="col-lg-3 mt-4">
                            <div class="card text-left">
                              <img class="card-img-top" src="holder.js/100px180/" alt="">
                              <div class="card-body text-center">
                                <h4 class="card-title ">{{ $historys->baadendumheaders->count() }}</h4>
                        ...
                        <div class="col-lg-3 mt-4">
                            <div class="card text-left">
                              <img class="card-img-top" src="holder.js/100px180/" alt="">
                              <div class="card-body text-center">
                                <h4 class="card-title ">{{ $historys->banegopengadaans->count() }}</h4>
                        ...
                        <div class="col-lg-3 mt-4">
                            <div class="card text-left">
                              <img class="card-img-top" src="holder.js/100px180/" alt="">
                              <div class="card-body text-center">
                                <h4 class="card-title ">{{ $historys->spkheaders->count() }}</h4>
                        ...
                        <div class="col-lg-3 mt-4">
                            <div class="card text-left">
                              <img class="card-img-top" src="holder.js/100px180/" alt="">
                              <div class="card-body text-center">
                                <h4 class="card-title ">{{ $historys->sppheaders->count() }}</h4>
