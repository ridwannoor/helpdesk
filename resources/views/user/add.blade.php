        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="m-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="m-form m-form--label-align-right" method="POST" action="/user/store" enctype="multipart/form-data">
                        ...
                        <div class="m-portlet__body">
                            <div class="m-form__section m-form__section--first">
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="name" class="form-control m-input" placeholder="Enter Nama">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control m-bootstrap-select m_selectpicker" name="lokasi_id[]" multiple data-actions-box="true">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <input type="file" name="image" class="form-control m-input" >
                                        {{-- <span class="m-form__help">{{$users->image}}</span> --}}
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
