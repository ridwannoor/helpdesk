        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="m-portlet">
                    ...
                    <!--begin::Form-->
                    <form class="m-form m-form--label-align-right" method="POST" action="/tender/store" enctype="multipart/form-data">
                            ...
                            <div class="m-form__section m-form__section--first">
                                <div class="form-group m-form__group row">
                                    ...
                                    <label>Nomor Pengumuman</label>                                    
                                        <input type="text" name="nomor_pr" class="form-control m-input">
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <div class="input-group date"  data-z-index="1100">
                                            <input type="text" class="form-control m-input" readonly name="tgl_paket" placeholder="Select date & time" id="tgl"/>
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-lg-3">
                                        ...
                                        <textarea name="lokasi_pekerjaan" id="nama_paket" class="form-control m-input" cols="30" rows="5"></textarea>                                      
                                        {{-- <input type="text" name="lokasi_pekerjaan" class="form-control m-input" > --}}
                                    </div>
                                    <div class="col-lg-3">
                                        <label>Nama Paket</label>     
                                        <textarea name="nama_paket" id="nama_paket" class="form-control m-input" cols="30" rows="5"></textarea>                               
                                            {{-- <input type="text" name="nomor_pr" class="form-control m-input" placeholder="Nomor PR"> --}}
                                    </div>
                                   
                                    <div class="col-lg-6">
                                        <label>Uraian Pekerjaan</label>     
                                        <textarea name="uraian_pek"  id="summernote1" class="form-control m-input" required></textarea>
                                        {{-- <textarea name="uraian_pek" id="uraian_pek" class="form-control m-input" cols="30" rows="5"></textarea>                                --}}
                                            {{-- <input type="text" name="nomor_pr" class="form-control m-input" placeholder="Nomor PR"> --}}
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">  
                                    <div class="col-lg-3">
                                        ...
                                        <select  class="form-control m-bootstrap-select m_selectpicker" data-live-search="true"  name="jenispekerjaan_id[]" id="jenispekerjaan" multiple>
                                            @foreach ($jnspek as $item)                                                
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input type="text" name="pagu" class="form-control m-input" >
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">  
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        <label>Unit ST</label>
                                        <select  class="form-control m-bootstrap-select m_selectpicker" data-live-search="true"  name="divisi_id" id="statustender_id">
                                ...
                                <div class="form-group m-form__group row"> 
                                    <div class="col-lg-3">
                                        ...
                                        <input type="text" name="jangka_pelaksanaan" class="form-control m-input" >
                                    </div>
                                    <div class="col-lg-3">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input type="text" name="jangka_pemeliharaan" class="form-control m-input" >
                                    </div>
                                    <div class="col-lg-3">
                                        <label>Jaminan Pelaksanaan</label>                                    
                                        <input type="text" name="jaminan_pelaksanaan" class="form-control m-input" >
                                    </div>
                                </div>
                                <div class="form-group m-form__group row"> 
                                    <div class="col-lg-6">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="input-group">                                                    
                                                        <input type="hidden" name="vendorklasifikasi_id[]" id="vendorklasifikasi_id" class="form-control m-input">
                                    ...
                                    <table class="table table-striped-table-bordered table-hover" id="tblAddRow2">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="input-group">                                                    
                                                        <input type="hidden" name="syarattender_id[]" id="syarattender_id" class="form-control m-input">
                                                        {{-- <input type="hidden" name="currency_id[]" id="currency_id" class="form-control m-input" value=""> --}}
                                                    ...
                                                    <td> <textarea name="detail_syarat[]" id="detail_syarat" class="form-control m-input " 
                                                        required readonly cols="30" rows="5"></textarea>
