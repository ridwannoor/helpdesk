            ...
            <div class="m-portlet">
                <div class="m-portlet__body m-portlet__body--no-padding">
                    <div class="m-invoice-2">
                        <form action="/pum/update/detail" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                <input type="hidden" name="_method" value="PUT" />
                                <input type="hidden" name="id" value="{{ $pums->id }}" />
                                <input type="hidden" name="no_pum" value="{{ $pums->no_pum }}" />
                                <input type="hidden" name="tanggal" value="{{ $pums->tanggal }}" />
                                <input type="hidden" name="lokasi_id" value="{{ $pums->lokasi_id }}" />
                                <input type="hidden" name="preference_id" value="{{ $pums->preference_id }}" />
                                <input type="hidden" name="bod_id" value="{{ $pums->bod_id }}" />
                                <input type="hidden" name="divisi_id" value="{{ $pums->divisi_id }}" />
                                <input type="hidden" name="divisi1_id" value="{{ $pums->divisi1_id }}" />
                                <input type="hidden" name="nama_pek" value="{{ $pums->nama_pek }}" />
                                <input type="hidden" name="total" value="{{ $pums->total }}" />

                                @foreach ($pums->pumdetails as $detail)
                                    ...
                                    <div class="m-invoice__container m-invoice__container--centered">
                                        ...
                                        <div class="m-invoice__items">
                                            <div class="m-invoice__item">
                                                ...
                                                <span class="m-invoice__text">{{ $pums->no_pum }}</span>
                                            </div>
                                            {{-- <div class="m-invoice__item">
                                            ...
                                            <div class="m-invoice__item">
                                                ...
                                                <span class="m-invoice__text">{{ $pums->nama_pek }}, {{ $pums->lokasi->kode }}</span>
                                            </div>
                                        </div>
                                        <div class="m-invoice__items">
                                            ...
                                            <div class="m-invoice__item">
                                                ...
                                                <span class="m-invoice__text"> {{ $pums->divisi->name}}, {{ $pums->divisi->kode}}</span>
                                            </div>
                                            ...
                                            <div class="m-invoice__item">
                                                <span class="m-invoice__subtitle">Menyetujui</span>
                                                <span class="m-invoice__text">{{ $pums->bod->name}}, {{ $pums->bod->code}}</span>
                                            </div>
                                            {{-- <div class="m-invoice__item">
                                                ...
                                                <span class="m-invoice__text">
                                                    ...
                                                    @elseif ($pums->pajak == "ppn")
                                                    <span>Include Tax (V1)</span>
                                                    @elseif ($pums->pajak == "other")
                                                    <span>Include Tax (V1)</span>
                                                    @else
                                            ...
                                            {{-- <div class="m-invoice__item">
                                                ...
                                                <span class="m-invoice__text">{{ $pums->vendor->namaperusahaan }},
                                                    {{ $pums->vendor->badanusaha->kode }}</span>
                                            </div> --}}
                                        </div>
                                    </div>
                                </div>
