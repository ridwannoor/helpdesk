                            ...
                            <div class="m-invoice__head"
                                ...
                                <div class="m-invoice__container m-invoice__container--centered">
                                    <div class="m-invoice__logo">
                                        <a href="#">
                                            <h3>Permintaan Uang Muka (PUM)</h3>
                                        </a>
                                        <a href="#">
                                          <img src="{{ url('data_file/'.$pums->preference->image) }}" width="250px" alt="">  
                                        </a>
                                    </div>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="m-widget4__item">
                                                        ...
                                                        <div class="m-widget4__ext" >
                                                            <a href="/pum/destroyfile/{{$item->id}}" class="m-widget4__icon delete-confirm">
