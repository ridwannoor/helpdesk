    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="m-portlet">
                ...
                <!--begin::Form-->
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="POST" action="/pum/store" enctype="multipart/form-data">
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4">
                                <label>Nomor PUM:</label>
                                <input type="text" name="no_pum" class="form-control m-input" value="{{ $noUrutAkhir }}" readonly>
