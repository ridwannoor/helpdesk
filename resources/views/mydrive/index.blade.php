            ...
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        <a href="/mydrive" class="m-nav__link">
...
<div class="m-content">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1_wrapper">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- <td style="vertical-align : middle;text-align:center;">{{ $item->aset_tag }}</td>
                            <td style="vertical-align : middle;text-align:center;">{{ $item->tahun_perolehan }}</td> --}}
                            <td  style="vertical-align : middle;text-align:center;">
                                <span class="m-badge m-badge--brand m-badge--wide">  {{ $item->mydrivecategory->title }} <span>
                            </td>
                            <td width='130px'>
                                <a href="{{ url('data_file/my_drive/'.$item->file) }}" target="_blank"
                                    class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" ><i
                                        class="flaticon-download"></i></a>
                                @if ($crud->edit > 0)
                                <a href="/mydrive/edit/{{ $item->id }}"
                                    class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" >
                                    <i class="flaticon-edit"></i></a>
    
                                @endif
                                @if ($crud->destroy > 0)
                                    <a href="/mydrive/destroy/{{ $item->id }}"
    ...
    <div class="modal fade" id="m_blockui_4_1_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="/mydrive/store" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="mydrivecategory_id" id="mydrivecategory_id" class="form-control m-bootstrap-select m_selectpicker">
                        @foreach ($cats as $item)
                            {{-- <input type="hidden" name="titlecat" value="{{$item->title}}" /> --}}
